...
export default {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      serif: ["Noto serif thai", "sans-serif"],
    },
    colors: {
      text: {
      ...
      bg: {
        ...
        brand: {
          primary: "rgba(var(--bg-brand-primary), <alpha-value>)",
      ...
      utility: {
        ...
        error: {
          ...
          "800": "rgba(var(--utility-error-800), <alpha-value>)",
          "900": "rgba(var(--utility-error-900), <alpha-value>)",
          "950": "rgba(var(--utility-error-950), <alpha-value>)",
        },
        gray: {
        ...
        warning: {
          ...
          "800": "rgba(var(--utility-warning-800), <alpha-value>)",
          "900": "rgba(var(--utility-warning-900), <alpha-value>)",
          "950": "rgba(var(--utility-warning-950), <alpha-value>)",
        },
        "blue-light": {
          ...
          "800": "rgba(var(--utility-blue-light-800), <alpha-value>)",
          "900": "rgba(var(--utility-blue-light-900), <alpha-value>)",
        },
      },
      featured: {
        icon: {
